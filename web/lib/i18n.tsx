...
const STRINGS = {
  fr: {
    ...
    socHandle: 'Sakura Shop sur Facebook',
    socText: 'Nos dernières pièces en situation, et l’actualité de la boutique.',
  ...
  ar: {
    ...
    socKicker: 'عالمنا',
    socHandle: 'Sakura Shop على فيسبوك',
    socText: 'أحدث قطعنا وآخر أخبار المتجر.',
