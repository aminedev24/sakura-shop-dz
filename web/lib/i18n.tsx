...
const STRINGS = {
  fr: {
    ...
    sgHow: 'Comment mesurer',
    sgHow2: 'Tour de taille : à l’endroit le plus étroit, sans serrer le mètre.',
    sgHow3: 'Hanches : à l’endroit le plus fort, debout, pieds joints.',
    sgNote: 'Mesures du corps en centimètres, données à titre indicatif. Entre deux tailles, prenez la plus grande.',
    sgAsk: 'Un doute sur votre taille ? Écrivez-nous sur WhatsApp avant de commander.',
    sgTitle: 'Guide des tailles — mesures du corps en cm',
    sgStocked: 'Tailles disponibles en boutique',
    ...
    pdSoldOut: 'Épuisé',
    pdSizeGuide: 'Guide des tailles',
    pdSizeGuideHide: 'Masquer le guide',
    pdSaving: 'Vous économisez',
    pdInStock: 'En stock',
    pdLeft: 'Plus que {x} en stock',
    pdOut: 'Épuisé',
    pdPhotos: 'Photos du modèle',
    pdVariant: 'Modèle choisi :',
    pdColor: 'Couleur',
    pdPickColor: 'Choisissez une couleur',
    color: 'Couleur',
    tColorT: 'Choisissez une couleur',
    tColorS: 'Sélectionnez une couleur avant d’ajouter',
  ...
  ar: {
    ...
    sgFr: 'المقاس الفرنسي',
    sgHow: 'كيف تقيسين',
    sgHow2: 'الخصر: عند أضيق نقطة، دون شدّ الشريط.',
    sgHow3: 'الأرداف: عند أعرض نقطة، واقفة والقدمان متلاصقتان.',
    sgNote: 'قياسات الجسم بالسنتيمتر، للاسترشاد فقط. إذا كنت بين مقاسين، اختاري الأكبر.',
    sgAsk: 'غير متأكدة من مقاسك؟ راسلينا على واتساب قبل الطلب.',
    sgTitle: 'دليل المقاسات — قياسات الجسم بالسنتيمتر',
    sgStocked: 'المقاسات المتوفرة في المتجر',
    ...
    pdSoldOut: 'نفد',
    pdSizeGuide: 'دليل المقاسات',
    pdSizeGuideHide: 'إخفاء الدليل',
    pdSaving: 'توفّرين',
    pdInStock: 'متوفّر',
    pdLeft: 'بقيت {x} قطع فقط',
    pdOut: 'نفدت الكمية',
    pdPhotos: 'صور الموديل',
    pdVariant: 'الموديل المختار:',
    pdColor: 'اللون',
    pdPickColor: 'اختاري لونًا',
    color: 'اللون',
    tColorT: 'اختاري لونًا',
    tColorS: 'حدّدي اللون قبل الإضافة',
